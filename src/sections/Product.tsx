...
export function Product() {
  ...
  if (!productConfig.mainTitle) return null;
    ...
    >
      <div className="container-custom">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-[#1E2761]">{t('product.title')}</h2>
        </div>

        {/* Courses Section */}
        <div className="mb-20">
          <h3 className={`font-serif text-2xl md:text-3xl text-[#1E2761] mb-8 transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            {t('product.coursesTitle')}
          </h3>
        ...
        {/* Bespoke Section */}
        <div>
          <h3 className={`font-serif text-2xl md:text-3xl text-[#1E2761] mb-8 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            {t('product.bespokeTitle')}
          </h3>
