...
export const newsConfig: NewsConfig = {
  ...
  articles: [
    ...
    },
    {
      ...
      excerpt: "CLB Kết nối tri thức ký kết thỏa thuận hợp tác với các trường đại học quốc tế.",
      date: "25/02/2026",
      category: "Đối tác",
    },
    {
  ...
  storyParagraphs: [
    "Từ những ngày đầu thành lập với chỉ một nhóm nhỏ đam mê nghiên cứu, CLB Kết nối tri thức đã không ngừng phát triển và mở rộng.",
    "Chúng tôi tự hào đã xây dựng được một cộng đồng tri thức sôi động với hàng nghìn thành viên và đối tác.",
  ],
  storyTimeline: [
    { value: "500+", label: "Tài liệu" },
    { value: "50+",  label: "Khóa học" },
    { value: "1200+", label: "Thành viên" },
    { value: "20+",  label: "Đối tác" },
  ],
  storyQuote: {
    prefix: "",
    text: "Cùng nhau xây dựng cộng đồng tri thức vững mạnh.",
    attribution: "CLB Kết nối tri thức",
  },
  storyImage: "/images/resource-3.jpg",
  storyImageCaption: "Cộng đồng CLB Kết nối tri thức",
};
